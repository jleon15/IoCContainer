...
public class Person {
    ...
    public void defaultInitMethod(){
        System.out.println("Printing default init method for test.com.ci1330.ecci.ucr.ac.cr.test.com.ci1330.ecci.ucr.ac.cr.Person");
    }

    public void defaultDestroyMethod(){
        System.out.println("Printing default destroy method for test.com.ci1330.ecci.ucr.ac.cr.test.com.ci1330.ecci.ucr.ac.cr.Person");
    }
    ...
    public void print(){
        System.out.println("\ntest.com.ci1330.ecci.ucr.ac.cr.Person's information: \n " + "Name: " + name + "\n Nationatily: " + nationality + "\n Civil Status: " + civilStatus
